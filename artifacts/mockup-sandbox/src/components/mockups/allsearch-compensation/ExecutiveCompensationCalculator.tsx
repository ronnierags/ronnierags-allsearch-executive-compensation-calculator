    ...
    <div className="min-h-screen bg-[#f6f6f3] text-[#26364b]" style={{ fontFamily: "'DM Sans', ui-sans-serif, system-ui, sans-serif" }}>
      ...
      <main className="mx-auto max-w-[1040px] px-3 pb-16 pt-3">
        <div className="grid gap-3 rounded-lg bg-[#142e55] p-3 shadow-[0_2px_9px_rgba(20,46,85,.13)] md:grid-cols-[1.25fr_1fr_1fr_1fr_1.2fr_auto] md:items-end">
          ...
          <label className="text-[8px] uppercase tracking-[.1em] text-[#9db0c6]">Candidate / role<input value={candidate} onChange={(e) => setCandidate(e.target.value)} placeholder="Name / title" className="mt-1 h-7 w-full rounded border-0 bg-[#fffefb] px-2 text-[10px] text-[#243650] outline-none placeholder:text-[#8b949e] focus:ring-2 focus:ring-[#c3a34c]" /></label>
          <label className="text-[8px] uppercase tracking-[.1em] text-[#9db0c6]">Year 1<input value={year} onChange={(e) => setYear(e.target.value)} className="mt-1 h-7 w-full rounded border-0 bg-[#fffefb] px-2 text-[10px] text-[#243650] outline-none focus:ring-2 focus:ring-[#c3a34c]" /></label>
          <label className="text-[8px] uppercase tracking-[.1em] text-[#9db0c6]">Years to model<input value={years} onChange={(e) => setYears(e.target.value)} className="mt-1 h-7 w-full rounded border-0 bg-[#fffefb] px-2 text-[10px] text-[#243650] outline-none focus:ring-2 focus:ring-[#c3a34c]" /></label>
          <label className="text-[8px] uppercase tracking-[.1em] text-[#9db0c6]">Market reference (total comp)<input value={reference} onChange={(e) => setReference(e.target.value)} className="mt-1 h-7 w-full rounded border-0 bg-[#fffefb] px-2 text-[10px] text-[#243650] outline-none focus:ring-2 focus:ring-[#c3a34c]" /></label>
