...
export const getExportLeadsCsvUrl = () => {
  ...
  return `/api/admin/leads.csv`
}

/**
 * @summary Export captured leads as CSV
 */
export const exportLeadsCsv = async ( options?: Parameters<typeof customFetch>[1]): Promise<string> => {
...
export const getExportLeadsCsvQueryOptions = <TData = Awaited<ReturnType<typeof exportLeadsCsv>>, TError = ErrorType<void>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof exportLeadsCsv>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getExportLeadsCsvQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof exportLeadsCsv>>> = ({ signal }) => exportLeadsCsv({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof exportLeadsCsv>>, TError, TData> & { queryKey: QueryKey }
}

export type ExportLeadsCsvQueryResult = NonNullable<Awaited<ReturnType<typeof exportLeadsCsv>>>
export type ExportLeadsCsvQueryError = ErrorType<void>
...
export function useExportLeadsCsv<TData = Awaited<ReturnType<typeof exportLeadsCsv>>, TError = ErrorType<void>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof exportLeadsCsv>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
